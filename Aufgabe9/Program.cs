...
namespace Aufgabe9
{
    class Program
    {
        ...
        public void AddNewQuestion()
        {
            ...
            string rightUserAnswer = Console.ReadLine();
            ...
            SaveQuestion(addQuestionType, addUserQuestion, addHowManyAnswers, rightUserAnswer, score);
            
        }

        static void SaveQuestion(string addQuestionType, string addUserQuestion, int addHowManyAnswers, string rightUserAnswer, int score)
        {
            ...
            XmlSerializer answer = new XmlSerializer(rightUserAnswer.GetType());
            answer.Serialize(read,rightUserAnswer);
